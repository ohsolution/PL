...
public:
  ...
  enum {
    ...
    RuleFccall = 39, RuleArgus = 40, RuleArgu = 41, RuleOprpostfix = 42, 
    RulePrefixopr = 43, RuleMulopr = 44, RuleAddopr = 45, RuleInopr = 46, 
    RuleIsopr = 47, RuleEqopr = 48, RuleCmpopr = 49, RuleVariableD = 50, 
    RulePropertyD = 51, RuleTypef = 52, RuleValue = 53
  };
